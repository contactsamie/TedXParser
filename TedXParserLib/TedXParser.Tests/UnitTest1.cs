...
namespace TedXParser.Tests
{
    ...
    public class UnitTest1
    {
        ...
        public UnitTest1()
        {
            Recorder = new TedXParserUtils();
        }

        private string file = @"C:\aud_prog\sample_orig.wav";
        [TestMethod]
        public void record_start()
        {
            ...
            Task.Delay(TimeSpan.FromMinutes(10000)).Wait();
        }

        public TedXParserUtils Recorder { get; set; }
